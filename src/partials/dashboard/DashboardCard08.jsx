  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 bg-gradient shadow-lg rounded-sm">
      <header className="px-5 py-4 border-b border-slate-100 flex items-center">
        <h2 className="font-bold text-indigo-500">Funds Recieved vs Exhausted</h2>
        
      </header>
      <div className="px-5 py-3">
        <div className="flex items-start">
          <div className="text-3xl font-bold text-white mr-2">+$4.2K</div>
          <div className="text-sm font-semibold text-white px-1.5 bg-red-500 rounded-full">-13%</div>
        </div>
      </div>
