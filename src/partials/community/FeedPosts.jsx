...
function FeedPosts() {
  return (
    <>
      {/* Post 1 */}
      <div className="bg-gradient shadow-md rounded border border-slate-200 p-5">
        {/* Header */}
        ...
        <footer className="flex items-center space-x-4">
          {/* Like button */}
          <button className="flex items-center text-indigo-500 hover:text-indigo-500">
          ...
          <button className="flex items-center text-indigo-500 hover:text-indigo-500">
            ...
            <div className="text-sm text-white">44</div>
          </button>
          {/* Replies button */}
          <button className="flex items-center text-indigo-500 hover:text-indigo-500">
            <svg className="w-4 h-4 shrink-0 fill-current mr-1.5" viewBox="0 0 16 16">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <div className="inline-flex items-center">
                ...
                <div className="text-xs text-white">Sponsored</div>
              </div>
            </div>
          </div>
          {/* Menu button */}
      ...
      <div className="bg-gradient shadow-md rounded border border-slate-200 p-5">
        ...
        <footer className="flex items-center space-x-4">
          ...
          <button className="flex items-center text-indigo-500 hover:text-indigo-500">
            ...
            <div className="text-sm text-white">122</div>
          </button>
          {/* Share button */}
          <button className="flex items-center text-indigo-500 hover:text-indigo-500">
            <svg className="w-4 h-4 shrink-0 fill-current mr-1.5" viewBox="0 0 16 16">
          ...
          <button className="flex items-center text-indigo-500 hover:text-indigo-500">
            ...
            <div className="text-sm text-white">298</div>
          </button>
        </footer>
        {/* Comments */}
        <div className="mt-5 pt-3 border-t border-slate-200">
          <ul className="space-y-2 mb-3">
            {/* Comment */}
            <li className="p-3 gradient rounded">
              <div className="flex items-start space-x-3">
            ...
            {/* Comment */}
            <li className="p-3 bg-gradient rounded">
              <div className="flex items-start space-x-3">
          ...
          <div className="flex justify-between space-x-2">
            <div className="text-sm text-slate-500">
              <span className="font-medium text-white">2 of </span><span className="font-medium text-white">67 comments</span>
            </div>
          ...
          <div className="flex items-center space-x-3 mt-3">
            ...
            <div className="grow">
              <label htmlFor="comment-form" className="sr-only text-white">
                Write a comment…
              </label>
              <input
                id="comment-form"
                className="form-input w-full bg-gradient border-transparent focus:bg-white focus:border-slate-300 placeholder-slate-500"
                type="text"
      ...
      <div className="bg-gradient shadow-md rounded border border-slate-200 p-5">
        ...
        <footer className="flex items-center space-x-4">
          ...
          <button className="flex items-center text-indigo-400">
            ...
            <div className="text-sm text-white">2.2K</div>
          </button>
          {/* Share button */}
          <button className="flex items-center text-indigo-500 hover:text-indigo-500">
            <svg className="w-4 h-4 shrink-0 fill-current mr-1.5" viewBox="0 0 16 16">
            ...
            <div className="text-sm text-white">4.3K</div>
          </button>
          {/* Replies button */}
          <button className="flex items-center text-indigo-500 hover:text-indigo-500">
            <svg className="w-4 h-4 shrink-0 fill-current mr-1.5" viewBox="0 0 16 16">
            ...
            <div className="text-sm text-white">92</div>
          </button>
        </footer>
      </div>
    </>
