...
function UsersTilesCard(props) {
  return (
    <div className="col-span-full sm:col-span-6 xl:col-span-4 bg-gradient shadow-lg rounded-sm border border-slate-200">
      <div className="flex flex-col h-full">
            ...
            <header>
              <div className="flex mb-2">
                ...
                <div className="mt-1 pr-1">
                  <Link className="inline-flex text-slate-800 hover:text-slate-900" >
                    <h2 className="text-xl leading-snug justify-center font-semibold text-indigo-500">{props.name}</h2>
                  </Link>
                  <div className="flex items-center text-white"><span className="text-sm font-medium text-white -mt-0.5 mr-1">-&gt;</span> <span>{props.location}</span></div>
                </div>
              </div>
            </header>
            {/* Menu button */}
        ...
        <div className="border-t border-slate-200">
          <div className="flex divide-x divide-slate-200r">
            ...
            <Link className="block flex-1 text-center text-sm text-white hover:text-slate-800 font-medium px-3 py-4" to={props.link}>
              <div className="flex items-center justify-center">
                <svg className="w-4 h-4 fill-current text-white group-hover:text-slate-500 shrink-0 mr-2" viewBox="0 0 16 16">
                  <path d="M11.7.3c-.4-.4-1-.4-1.4 0l-10 10c-.2.2-.3.4-.3.7v4c0 .6.4 1 1 1h4c.3 0 .5-.1.7-.3l10-10c.4-.4.4-1 0-1.4l-4-4zM4.6 14H2v-2.6l6-6L10.6 8l-6 6zM12 6.6L9.4 4 11 2.4 13.6 5 12 6.6z" />
                </svg>
                <span>Contact Formally</span>
              </div>
            </Link>
          </div>
        </div>
