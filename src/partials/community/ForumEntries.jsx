...
function ForumEntries() {
  return (
    <>
      {/* Post 1 */}
      <article className="bg-gradient shadow-md rounded border border-slate-200 p-5">
        <div className="flex flex-start space-x-4">
          ...
          <div className="grow">
            ...
            <footer className="flex flex-wrap text-sm">
              ...
              <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                <span className="text-indigo-500">7d</span>
              </div>
              <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                <span className="text-indigo-500">688 Comments</span>
              </div>
            </footer>
          </div>
          {/* Upvote button */}
        ...
        <div className="flex flex-start space-x-4">
          ...
          <div className="grow">
            ...
            <footer className="flex flex-wrap text-sm">
              ...
              <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                <span className="text-indigo-500">4h</span>
              </div>
              <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                <span className="text-indigo-500">14 Comments</span>
              </div>
            </footer>
          </div>
          {/* Upvote button */}
        ...
        <div className="flex flex-start space-x-4">
          ...
          <div className="grow">
            ...
            <footer className="flex flex-wrap text-sm">
              ...
              <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                <span className="text-indigo-500">2h</span>
              </div>
              <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                <span className="text-indigo-500">17 Comments</span>
              </div>
            </footer>
          </div>
          {/* Upvote button */}
        ...
        <div className="flex flex-start space-x-4">
          ...
          <div className="grow">
            ...
            <footer className="flex flex-wrap text-sm">
              ...
              <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                <span className="text-indigo-500">2d</span>
              </div>
              <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                <span className="text-indigo-500">298 Comments</span>
              </div>
            </footer>
          </div>
          {/* Upvote button */}
        ...
        <div className="flex flex-start space-x-4">
          ...
          <div className="grow">
            ...
            <footer className="flex flex-wrap text-sm">
              ...
              <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                <span className="text-indigo-500">312 Comments</span>
              </div>
            </footer>
          </div>
          {/* Upvote button */}
      ...
      {/* Promoted post */}
      <article className="bg-gradient shadow-md rounded border border-amber-300 p-5">
        <div className="flex flex-start space-x-4">
          {/* Avatar */}
          <div className="shrink-0 mt-1.5">
        ...
        <div className="flex flex-start space-x-4">
          ...
          <div className="grow">
            ...
            <footer className="flex flex-wrap text-sm">
              ...
              <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                <span className="text-indigo-500">3d</span>
              </div>
              <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                <span className="text-indigo-500">66 Comments</span>
              </div>
            </footer>
          </div>
          {/* Upvote button */}
        ...
        <div className="flex flex-start space-x-4">
          ...
          <div className="grow">
            ...
            <footer className="flex flex-wrap text-sm">
              ...
              <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                <span className="text-indigo-500">32 Comments</span>
              </div>
            </footer>
          </div>
          {/* Upvote button */}
        ...
        <div className="flex flex-start space-x-4">
          ...
          <div className="grow">
            ...
            <footer className="flex flex-wrap text-sm">
              ...
              <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                <span className="text-indigo-500">4d</span>
              </div>
              <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                <span className="text-indigo-500">27 Comments</span>
              </div>
            </footer>
          </div>
          {/* Upvote button */}
        ...
        <div className="flex flex-start space-x-4">
          ...
          <div className="grow">
            ...
            <footer className="flex flex-wrap text-sm">
              ...
              <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                <span className="text-indigo-500">5d</span>
              </div>
              <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                <span className="text-indigo-500">61 Comments</span>
              </div>
            </footer>
          </div>
          {/* Upvote button */}
