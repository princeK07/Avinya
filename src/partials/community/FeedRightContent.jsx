        ...
        <div className="md:py-8">
          ...
          <div className="mb-6">
            <form className="relative">
              ...
              <input id="feed-search-desktop" className="form-input w-full pl-9 bg-gradient focus:border-slate-300" type="search" placeholder="Search…" />
          ...
          <div className="space-y-4">
            ...
            {/* Block 1 */}
            <div className="bg-gradient p-4 rounded border border-slate-200">
              <div className="text-xs font-semibold text-white uppercase mb-4">Top Communities</div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="grow flex items-center">
                      ...
                      <div className="truncate">
                        <span className="text-sm font-medium text-white">Introductions</span>
                      </div>
                    </div>
                ...
                <li>
                  <div className="flex items-center justify-between">
                    <div className="grow flex items-center">
                      ...
                      <div className="truncate">
                        <span className="text-sm font-medium text-white">HackerNews</span>
                      </div>
                    </div>
                    <button className="text-xs inline-flex font-medium bg-indigo-100 text-indigo-600 rounded-full text-center px-2.5 py-1">
                      Join
                ...
                <li>
                  <div className="flex items-center justify-between">
                    <div className="grow flex items-center">
                      ...
                      <div className="truncate">
                        <span className="text-sm font-medium text-white">ReactJs</span>
                      </div>
                    </div>
                ...
                <li>
                  <div className="flex items-center justify-between">
                    <div className="grow flex items-center">
                      ...
                      <div className="truncate">
                        <span className="text-sm font-medium text-white">JustChatting</span>
                      </div>
                    </div>
                    <button className="text-xs inline-flex font-medium bg-indigo-100 text-indigo-600 rounded-full text-center px-2.5 py-1">
                      Join
              ...
              <div className="mt-4">
                <button className="btn-sm w-full bg-gradient border-slate-200 hover:border-slate-300 text-indigo-500 shadow-none">View All</button>
              </div>
            </div>
            
            {/* Block 2 */}
            <div className="bg-gradient p-4 rounded border border-slate-200">
              <div className="text-xs font-semibold text-white uppercase mb-4">Who to follow</div>
              <ul className="space-y-3">
                <li>
                  <div className="flex items-center justify-between">
                    <div className="grow flex items-center">
                      ...
                      <div className="truncate">
                        <span className="text-sm font-medium text-white">Elly Boutin</span>
                      </div>
                    </div>
                    <button className="text-xs inline-flex font-medium bg-indigo-100 text-indigo-600 rounded-full text-center px-2.5 py-1">
                      Follow
                ...
                <li>
                  <div className="flex items-center justify-between">
                    <div className="grow flex items-center">
                      ...
                      <div className="truncate">
                        <span className="text-sm font-medium text-white">Rich Harris</span>
                      </div>
                    </div>
                    <button className="text-xs inline-flex font-medium bg-indigo-100 text-indigo-600 rounded-full text-center px-2.5 py-1">
                      Follow
                ...
                <li>
                  <div className="flex items-center justify-between">
                    <div className="grow flex items-center">
                      ...
                      <div className="truncate">
                        <span className="text-sm font-medium text-white">Mary Porzio</span>
                      </div>
                    </div>
                    <button className="text-xs inline-flex font-medium bg-indigo-100 text-indigo-600 rounded-full text-center px-2.5 py-1">
                      Follow
                ...
                <li>
                  <div className="flex items-center justify-between">
                    <div className="grow flex items-center">
                      ...
                      <div className="truncate">
                        <span className="text-sm font-medium text-white">Brian Lovin</span>
                      </div>
                    </div>
                    <button className="text-xs inline-flex font-medium bg-indigo-100 text-indigo-600 rounded-full text-center px-2.5 py-1">
                      Follow
            ...
            {/* Block 3 */}
            <div className="bg-gradient p-4 rounded border border-slate-200">
              <div className="text-xs font-semibold text-white uppercase mb-4">Trends for you</div>
              <ul className="space-y-3">
                <li>
                  <div className="text-sm mb-1">
                    <a className="font-medium text-white" href="#0">
