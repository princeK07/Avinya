        ...
        <div className="md:py-8">
          <div className="flex justify-between items-center md:block">
            ...
            <header className="mb-6">
              <h1 className="text-2xl md:text-3xl text-indigo-500 font-bold">Forum ✨</h1>
            </header>
          ...
          <div className="flex flex-nowrap overflow-x-scroll no-scrollbar md:block md:overflow-auto px-4 md:space-y-3 -mx-4">
              ...
              <ul className="flex flex-nowrap md:block mr-3 md:mr-0">
                ...
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a className="flex items-center px-2.5 py-2 rounded whitespace-nowrap" href="#0">
                    ...
                    <span className="text-sm font-medium text-indigo-500">Reading List</span>
                  </a>
                </li>
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a className="flex items-center px-2.5 py-2 rounded whitespace-nowrap" href="#0">
                    ...
                    <span className="text-sm font-medium text-indigo-500">Listings</span>
                  </a>
                </li>
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a className="flex items-center px-2.5 py-2 rounded whitespace-nowrap" href="#0">
                    ...
                    <span className="text-sm font-medium text-indigo-500">Podcasts</span>
                  </a>
                </li>
              </ul>
            </div>
            {/* Group 2 */}
            <div>
              <div className="text-xs font-semibold text-indigo-500 uppercase mb-3">My Groups</div>
              <ul className="flex flex-nowrap md:block mr-3 md:mr-0">
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a className="flex items-center px-2.5 py-2 rounded whitespace-nowrap" href="#0">
                    ...
                    <span className="text-sm font-medium text-indigo-500">Startups</span>
                  </a>
                </li>
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a className="flex items-center px-2.5 py-2 rounded whitespace-nowrap" href="#0">
                    ...
                    <span className="text-sm font-medium text-indigo-500">Javascript</span>
                  </a>
                </li>
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a className="flex items-center px-2.5 py-2 rounded whitespace-nowrap" href="#0">
                    ...
                    <span className="text-sm font-medium text-indigo-500">Productivity</span>
                  </a>
                </li>
              </ul>
            </div>
