      ...
      <div className="relative px-4 sm:px-6 pb-8">
        ...
        <div className="relative mb-6">
          ...
          <ul className="relative text-sm font-medium flex flex-nowrap -mx-4 sm:-mx-6 lg:-mx-8 overflow-x-scroll no-scrollbar">
            ...
            <li className="mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
              <a className="block pb-3 text-white hover:text-slate-600 whitespace-nowrap" href="#0">
                Connections
              </a>
            </li>
            <li className="mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
...
We aim to introduce the Healthcare sector to the digitisation that e-Commerce industry has benefited from in the last decade, with 5G and drone dilivery in place we will connect the disenfranchised to the country's healhcare network.
            ...
            {/* Departments */}
            <div>
              <h2 className="text-indigo-500 font-semibold mb-2">Our Clients</h2>
              {/* Cards */}
              <div className="grid xl:grid-cols-2 gap-4">
                {/* Card */}
                <div className="bg-gradient p-4 border border-slate-200 rounded-sm shadow-sm">
                  {/* Card header */}
            ...
            {/* Work History */}
            <div>
              <h2 className="text-indigo-500 font-semibold mb-2">Highlights</h2>
              <div className="bg-gradient p-4 border border-slate-200 rounded-sm shadow-sm">
