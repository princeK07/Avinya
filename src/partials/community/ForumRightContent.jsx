        ...
        <div className="md:py-8">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gradient p-4 rounded border border-slate-200">
              <div className="text-xs font-semibold text-white uppercase mb-4">Forum Meetups</div>
              <ul>
                {/* Event 1 */}
              ...
              <div className="mt-4">
                <button className="btn-sm w-full bg-indigo-500 border-slate-200 hover:border-slate-300 text-white shadow-none">View All</button>
              </div>
            </div>
            
            {/* Block 2 */}
            <div className="bg-gradient p-4 rounded border border-slate-200">
              <div className="text-xs font-semibold text-indigo-500 uppercase mb-4">Popular Stories</div>
