      ...
      <div className="sticky top-16 bg-gradient overflow-x-hidden overflow-y-auto no-scrollbar shrink-0 border-r border-slate-200 md:w-72 xl:w-80 h-[calc(100vh-64px)]">
        ...
        <div>
          ...
          <div className="sticky top-0 z-10">
            <div className="flex items-center bg-gradient border-b border-slate-200 px-5 h-16">
          ...
          <div className="px-5 py-4">
            ...
            {/* Team members */}
            <div className="mt-4">
              <div className="text-xs font-semibold text-slate-400 uppercase mb-3"></div>
              <ul className="mb-6">
                <li className="-mx-2">
                ...
                <li className="-mx-2">
                  <button className="w-full p-2 rounded" onClick={() => setProfileSidebarOpen(true)}>
                    <div className="flex items-center truncate">
                      <div className="relative mr-2">
